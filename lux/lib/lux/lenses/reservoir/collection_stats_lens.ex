defmodule Lux.Lenses.Reservoir.CollectionStatsLens do
  ...
  @impl true
  def before_focus(%{collection: collection} = _params) do
  ...
  defp transform_stats(data) do
    %{
      ...
      floor_price: get_in(data, ["floorAsk", "price", "amount", "decimal"]),
      volume_1d: get_in(data, ["volume", "1day"]),
      volume_all_time: get_in(data, ["volume", "allTime"])
    }
  end
end
