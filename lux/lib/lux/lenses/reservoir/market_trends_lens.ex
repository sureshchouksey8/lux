defmodule Lux.Lenses.Reservoir.MarketTrendsLens do
  ...
  def after_focus(%{"collections" => [collection_data | _]} = _response) do
    ...
    # Extract daily volumes from the nested object if available
    # The endpoint might return volumes array differently depending on the API version,
    # but we'll assume a basic structure.
