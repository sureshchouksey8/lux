defmodule Lux.Prisms.Telegram.Moderation.RestrictChatMember do
  @moduledoc """
    ...
    input_schema: %{
      ...
      properties: %{
        ...
        use_independent_chat_permissions: %{
          type: :boolean,
          description: "Pass True if chat permissions are set independently from supergroup restrictions"
        },
        until_date: %{
          type: :integer,
